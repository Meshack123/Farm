...
<body class="bg-light">
    ...
    <section class="blog-box">
        <div class="about-img" style="background-image:url(images/innerheader.jpg)">
            <h1 class="text-center text-white fw-bold about-text">CATEGORIES</h1>
        </div>
    ...
    <section class="ftco-section">
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    <h1 class="mb-4 fw-bold text-uppercase">Fruit & Beverages</h1>
                </div>
            </div>
        </div>
        <div class="container-fluid px-md-4 pb-5">
            <div class="row">
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/melon.jpg);">
                        <div class="text">
                            <h3><a href="view-categories.php">Watermelon</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/efo.jpg);">
                        <div class="text">
                            <h3><a href="#">Vegetable</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/pineapple.jpg);">
                        <div class="text">
                            <h3><a href="#">Pineapple</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/orange.jpg);">
                        <div class="text">
                            <h3><a href="#">Orange</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    <h1 class="mb-4 fw-bold text-uppercase">Corns & Grains</h1>
                </div>
            </div>
        </div>
        <div class="container-fluid px-md-4 pb-5">
            <div class="row">
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/wheat.jpg);">
                        <div class="text">
                            <h3><a href="view-categories.php">Wheat</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/cassava.jpg);">
                        <div class="text">
                            <h3><a href="#">Cassava</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/rice.jpg);">
                        <div class="text">
                            <h3><a href="#">Rice</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                ...
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/yam.jfif);">
                        <div class="text">
                            <h3><a href="#">Yam</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center pb-5">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    <h1 class="mb-4 fw-bold text-uppercase">Animal</h1>
                </div>
            </div>
        </div>
        <div class="container-fluid px-md-4 pb-5">
            <div class="row">
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/goats.jpg);">
                        <div class="text">
                            <h3><a href="view-categories.php">Goat</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/broilers-feeding-indoors.jpg);">
                        <div class="text">
                            <h3><a href="#">Boiler</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/rabbit.jpg);">
                        <div class="text">
                            <h3><a href="#">Rabbit</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ftco-animate">
                    <div class="project-box img d-flex align-items-end" style="background-image: url(images/Adobe.jpeg);">
                        <div class="text">
                            <h3><a href="#">Chick</a></h3>
                            <a href="#" class="icon d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span></a>
                        </div>
                    </div>
                </div>
