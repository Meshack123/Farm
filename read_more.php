...
<body class="bg-light">
    ...
    <section class="post-blog">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="post-container bg-white shadow-lg rounded-4">
                        <div class="w-100 h-100 rounded-4" style="background-image:url(images/Newinsta1.jpg); background-size: cover; background-repeat: no-repeat;">
                ...
                <div class="col-md-6">
                    <div class="post-container">
                        <div class="py-5">
                            <h3 class="text-center text-success fw-bold">ORGANIC PRODUCT FOR HEALTHY LIVING</h3>
                            <p class="fw-semibold fs-4 pt-4 ps-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est quisquam deleniti accusantium dolores iste tempora, quidem magni unde? 
                                Laudantium, amet aliquid! Quam eos quo alias fugit doloribus repudiandae reiciendis. Facilis? Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est quisquam deleniti 
                                accusantium dolores iste tempora, quidem magni unde? Laudantium, amet aliquid! Quam eos quo alias fugit doloribus
                                 repudiandae reiciendis. Facilis?
                            </p>
                            <div class="shift-left">
                                <p class="">
                                <a href="#"><span class="fa fa-calendar mr-2 lead fw-semibold text-dark px-3"></span>Sept. 23, 2020</a>
                                <a href="#"><span class="fa fa-user mr-2 text-dark px-3"></span>Admin</a>
                                <a href="#" class="meta-chat"><span class="bi bi-eye-fill mr-2 px-3 text-dark"></span> 3</a>
                                </p>
                            </div>
                        </div>
                       <!-- <div class="post-details bg-light shadow-lg">
                            <div class="d-flex">
                                <div class="d-flex align-content-center me-2 post-info mt-3">
                                    <i class="bi bi-chat fs-5 pe-2"></i>
                                    <p class="post-text fw-semibold">Sept. 23, 2020</p>
                                </div>
                                <div class="d-flex align-content-center me-2 mt-3">
                                    <i class="bi bi-person fs-5 pe-2"></i>
                                    <p class="post-text fw-semibold">Admin</p>
                                </div>
                                <div class="d-flex align-content-center mt-3">
                                    <i class="bi bi-chat fs-5 pe-3"></i>
                                    <p class="post-text fw-semibold">3</p>
                                </div>
                            </div>
                        </div>

                        <div class="post-cont-info">
                            <h3 class="text-center text-success">ORGANIC PRODUCT FOR HEALTHY LIVING</h3>
                            <p class="text-center fw-semibold fs-4 pt-3 d-lg-block d-sm-none">Far far away, behind the word mountains, far from the countries Vokalia and consonantia...</p>
                            <p class="text-center fw-semibold fs-4 pt-3 d-sm-block d-lg-none">Far far away, behind the word mountains, <br>far from the countries Vokalia and consonantia...</p>
                        </div>

                        <div class="post-link">
                            <a href="#" class="fs-4 fw-semibold text-success post-read">Read More</a>
                        </div>-->
                    </div>
                </div>
            </div>
