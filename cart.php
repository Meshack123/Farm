...
<body class="shadow-lg">
        ...
        <div class="container d-flex bg-success rounded">
            ...
            <div class="collapse navbar-collapse bg-success mt-lg-0 mt-sm-2" id="navmenu">
                <ul class="navbar-nav mr-auto align-content-center">
                    ...
                    <li class="nav-item li-nav item-active fw-bold align-content-center">
    ...
    <section class="blog-box">
        <div class="about-img" style="background-image:url(images/innerheader.jpg)">
            <h1 class="text-center text-white fw-bold about-text title">SHOPPING CART</h1>
        </div>
    ...
    <section class="contact-box">
        <div class="container">
            <div class="bg-white cart-box">
                <div class="bg-light cart-guide">
                    <img src="images/green-shopping-cart-10909.svg" alt="cart" class="img-fluid carting">
                </div>

                <p class="lead fw-semibold text-center pt-4">Your cart is empty!</p>

                <p class="lead fw-normal text-center pt-2 pb-4">Browse our products and discover our best deals!</p>

                <p class="text-center bg-success py-3 lead fw-semibold"><a href="#" class="text-light">Visit Our Product</a></p>
                ...
                <div class="col-md-4">
                    <div class="checkout-box rounded-4">
                        <div class="w-100">
                            ...
                            <button class="btn btn-success btn-lg checkout shadow fw-semibold">CHECKOUT(<span>&#8358</span> 2,000)</button>
                        </div>
                    </div>
                </div>
            </div>
